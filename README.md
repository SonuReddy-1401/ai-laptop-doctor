...
| File | Lines | Purpose |
|---|---|---|
| [README.md](README.md) | 326 | This file, outlining the project architecture and features |
| [LOGIC.md](LOGIC.md) | 43 | In-depth architecture document explaining diagnostic reasoning and trigger logic |
| [main.py](main.py) | 177 | Core orchestrator: CLI loop, LLM invocation, permission gate, action dispatch |
| [sensors.py](sensors.py) | 178 | Hardware telemetry scanner: CPU, RAM, SSD, battery, thermals, drivers, logs |
| [actions.py](actions.py) | 283 | Automated repair toolkit: safe, executable Windows system commands |
| [knowledge_base.py](knowledge_base.py) | 45 | RAG engine: ingests PDFs → ChromaDB, queries via LLaMA 3.2 embeddings |
| [generate_dataset.py](generate_dataset.py) | 150 | Fine-tuning dataset generator: produces 500 synthetic JSONL training examples |
| [.gitignore](.gitignore) | 31 | Specifies intentionally untracked files to ignore |
